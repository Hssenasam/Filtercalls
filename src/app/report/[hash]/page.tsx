  ...
  return (
    <section className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <h1 className="text-4xl font-semibold tracking-tight text-white md:text-5xl">Caller Reputation Intelligence</h1>
        <p className="max-w-3xl text-white/55">Community risk signals, spam reports, and trust data — privacy-first, no raw numbers exposed.</p>
      ...
      <Card className={`border ${tone.border} ${tone.bg} p-5`}>
        <p className={`text-sm font-semibold ${tone.text}`}>{riskBannerText(summary)}</p>
      </Card>
