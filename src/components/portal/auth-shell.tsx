...
export function AuthShell({
  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/80 shadow-2xl shadow-blue-950/20 backdrop-blur">
      ...
      <div className="relative grid min-h-[720px] lg:grid-cols-[1.1fr_0.9fr]">
        <section className="flex flex-col justify-between border-b border-white/10 p-8 lg:border-b-0 lg:border-r lg:p-12">
          <div>
            ...
            <div className="mt-10 max-w-xl space-y-5">
              ...
              <p className="max-w-lg text-base leading-7 text-slate-300 sm:text-lg">{subtitle}</p>
            </div>
          </div>
        ...
        <section className="flex items-center justify-center p-5 sm:p-8 lg:p-10">
          <div className="w-full max-w-md rounded-[1.75rem] border border-white/10 bg-slate-900/85 p-6 shadow-2xl shadow-slate-950/40 sm:p-8">
            {children}
